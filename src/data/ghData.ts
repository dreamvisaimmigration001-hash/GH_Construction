import { Project, ServiceItem, IndustryItem, Testimonial, PartnerClient, JobPosition, ApplicationStatusRecord } from '../types';
...
export const COMPANY_INFO = {
  ...
  address: {
    street: '15859 116 Avenue NW',
    city: 'Edmonton',
    province: 'Alberta',
    postalCode: 'T5M 3W1',
    country: 'Canada',
    full: '15859 116 Avenue NW, Edmonton, AB T5M 3W1',
    mapsUrl: 'https://maps.google.com/?q=15859+116+Avenue+NW,+Edmonton,+Alberta+T5M+3W1'
  },
  phone: {
    display: '780-705-7108',
    href: 'tel:7807057108'
  },
  email: {
    general: 'info@ghconstruction.ca',
...
export const INDUSTRIES: IndustryItem[] = [
  {
    ...
    featuredProjects: ['Synapse', 'Stratica Dermatology', 'Gateway Surgery', 'Ivory Denture Clinic', 'Parkland Dental'],
    keyConsiderations: [
    ...
    coverImage: 'https://images.squarespace-cdn.com/content/v1/59668ef629687f451deeb479/1714066998157-C0IHR4HHVM7ZU5561KTE/GH-Synapse-BJang-92.jpg'
  },
  {
    id: 'commercial',
    name: 'Commercial',
    ...
    coverImage: 'https://images.squarespace-cdn.com/content/v1/59668ef629687f451deeb479/bf7e786c-97b2-41bb-99a1-0794ed03bac3/GH-BCMB-1.jpg'
  },
  {
    id: 'restaurant',
    name: 'Restaurant',
    ...
    coverImage: 'https://images.squarespace-cdn.com/content/v1/59668ef629687f451deeb479/1654534799644-88UCL9XM5IS1Z7N43KU9/GH-Felice+Cafe-86.jpg'
  },
  {
    id: 'retail',
    name: 'Retail',
    ...
    coverImage: 'https://images.squarespace-cdn.com/content/v1/59668ef629687f451deeb479/8ed2fd31-1ecd-4a1e-b376-727e8eecae0e/GH-Vine+Arts-20.jpg'
  }
];
...
export const MOCK_APPLICATION_RECORDS: ApplicationStatusRecord[] = [
  {
    ...
    notes: 'Technical takeoff assessment under review by Preconstruction Director. Portfolio verification completed.',
  ...
  },
  {
    ...
    notes: 'On-site technical interview scheduled at Edmonton headquarters. Site safety leadership review pending.',
  ...
  },
  {
    ...
    notes: 'Formal offer documentation issued. Background & credential check verified with honors.',
