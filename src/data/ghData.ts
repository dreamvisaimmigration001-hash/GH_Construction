...
export const INDUSTRIES: IndustryItem[] = [
  ...
  },
  {
    ...
    featuredProjects: ["Ivory Denture Clinic", "It'Sugar", "Kunitz Shoes Expansion"],
    keyConsiderations: [
...
export const TESTIMONIALS: Testimonial[] = [
  ...
  },
  {
    ...
    role: "Practice Owner",
    organization: "Scarborough Dental Clinic Expansion",
  },
];
...
export const JOB_POSITIONS: JobPosition[] = [
  {
    ...
    location: "Scarborough (Head Office & Sites)",
    type: "Full-Time",
  ...
  },
  {
    ...
    responsibilities: [
      ...
      "Issue tender packages and build strong relationships with Scarborough and regional sub-trades",
  ...
  },
  {
    ...
    location: "Scarborough & Surrounding Area",
    type: "Full-Time",
  ...
  },
  {
    ...
    department: "Project Management",
    location: "Scarborough (Hybrid Office/Site)",
    type: "Full-Time",
...
export const MOCK_APPLICATION_RECORDS: ApplicationStatusRecord[] = [
  ...
  },
  {
    ...
    notes:
      "On-site technical interview scheduled at Scarborough headquarters. Site safety leadership review pending.",
