...
export const ContactSection: React.FC = () => {
  ...
  const validate = () => {
    ...
    if (!formData.message.trim()) {
      errs.message =
        "Please provide details about your project scope or vision";
    }
    setErrors(errs);
            ...
            <div className="p-5 sm:p-10 bg-[#0d0f15] border border-white/[0.08] relative">
              {isSubmitted ? (
                <div
                  ...
                  className="py-12 text-center space-y-4 animate-fadeIn"
                >
                  ...
                  <p className="text-sm text-[#d6cebf] max-w-md mx-auto leading-relaxed">
                    ...
                    . A partner from GH Construction (Nadder or Terry Jomha)
                    will review your project requirements and follow up within 1
                    business day.
                  </p>
                  <div className="pt-6">
                    <button
                ...
                <form onSubmit={handleSubmit} noValidate className="space-y-6">
                  <div>
                    ...
                    <p className="text-sm sm:text-base text-[#d6cebf] font-light mt-1.5">
                      Fill in the details below and our construction leadership
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className={`w-full px-4 py-3.5 bg-[#08090c] border text-base text-[#f7f7f5] placeholder-[#5c584f] focus:outline-none transition-colors ${
                          errors.fullName
                            ? "border-rose-500"
                            : "border-white/[0.15] focus:border-[#c8aa7a]"
                        }`}
                      />
                      {errors.fullName && (
                    ...
                    <div>
                      ...
                      >
                        <option value="Healthcare & Medical">
                          Healthcare & Medical (Dental / Surgical)
                        </option>
                        ...
                        <option value="Specialty Commercial">
                          Specialty Commercial & High-End Interiors
                        </option>
                      </select>
                    </div>
                    ...
                    <div>
                      ...
                      <select
                        ...
                        onChange={(e) =>
                          setFormData({
                            ...formData,
                            spaceStatus: e.target.value,
                          })
                        }
                        className="w-full px-4 py-3.5 bg-[#08090c] border border-white/[0.15] focus:border-[#c8aa7a] text-base text-[#f7f7f5] focus:outline-none cursor-pointer"
                      >
                        <option value="Space Acquired / Leased">
                          Space Acquired / Leased
                        </option>
                        <option value="Negotiating Lease / Needs Review">
                          Negotiating Lease / Needs Review
                        </option>
                        <option value="Searching for New Space">
                          Searching for New Space
                        </option>
                        <option value="Modifying Existing Practice">
                          Modifying Existing Practice (Phased)
                        </option>
                      </select>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    <div>
                      ...
                      <select
                        ...
                        className="w-full px-4 py-3.5 bg-[#08090c] border border-white/[0.15] focus:border-[#c8aa7a] text-base text-[#f7f7f5] focus:outline-none cursor-pointer"
                      >
                        <option value="Immediate (< 2 Months)">
                          Immediate (&lt; 2 Months)
                        </option>
                    ...
                    <div>
                      ...
                      >
                        ...
                        <option value="Undetermined / Need Preliminary Estimate">
                          Undetermined / Need Preliminary Estimate
                        </option>
                      </select>
                    </div>
                  </div>
                  ...
                  <div>
                    <label className="block text-xs sm:text-sm font-mono uppercase tracking-wider text-[#d6cebf] mb-2 font-medium">
                      Scope Overview & Requirements{" "}
                      <span className="text-[#c8aa7a]">*</span>
                    </label>
                    <textarea
                      rows={4}
                  ...
                  <p className="text-xs sm:text-sm text-[#d6cebf] text-center font-mono">
                    All project inquiries are held in strict confidence. No spam
